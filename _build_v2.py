...
<div class="pnl active" id="p-visao">
  ...
  <div class="global-filters" style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:20px;padding:12px 16px;background:#fff;border-radius:var(--r12);box-shadow:var(--sh);align-items:center">
    ...
    <input type="text" class="fi" id="gfNome" placeholder="Buscar parceiro..." oninput="applyGlobalFilters()" style="min-width:160px">
...
<div class="pnl" id="p-dados">
  <div class="flt" style="flex-wrap:wrap;gap:8px;align-items:center">
    <input type="text" class="fi" id="searchName" placeholder="Buscar por nome..." style="min-width:160px">
  ...
  if(perspEl){
    ...
    if(isCurrentWeek && diasUteis < 5){
      ...
      if(adormecidos.length > 0){
        ...
        pH += '<table><thead><tr><th>Parceiro</th><th>Cat.</th><th>Leads s. ant.</th><th>Potencial adj.</th></tr></thead><tbody>';
...
(function(){
  ...
  document.getElementById('gfDateFrom').value=fmt(fromDate);
  document.getElementById('gfDateTo').value=fmt(toDate);
})();
